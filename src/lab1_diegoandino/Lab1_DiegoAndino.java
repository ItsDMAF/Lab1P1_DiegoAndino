package lab1_diegoandino;

import java.util.Scanner; 

public class Lab1_DiegoAndino {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--Bienvedido al sistema de calculo de promedio--");
        System.out.print("Ingrese su nombre: ");//Se ingresa el nombre del usuario
        String nombre = entrada.nextLine();
        
        //Se ingresan las notas de las cuatro classes
